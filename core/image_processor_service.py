...
7. 高浓度2次元/二次元卡通风格图片（动漫角色、虚拟角色、CG 绘画、插画等）
...
2. 穿着暴露的服装（比基尼、泳装、透视装、露脐装等）
3. 穿着可爱的女性化服装（可爱系、萌系服装、带有蕾丝/蝴蝶结/花边/荷叶边等元素）
4. 化着女性妆容或戴着女性假发
5. 摆出明显的女性化姿势或动作（如双手托腮、比心、卖萌等）
6. 穿着女性内衣、丝袜、长筒袜搭配裙装
7. 穿着带有明显女性化图案或文字的服装（如爱心、花朵、粉色系卡通等）

【排除条件】（满足以下条件应判断为"否"）：
1. 仅穿着普通男装（T 恤、衬衫、卫衣、夹克、运动服、牛仔裤、休闲裤等）
2. 仅露出部分皮肤但穿着明显男装（如赤膊、穿背心、穿短裤的男生）
...
示例：
是 | 穿着黄色洛丽塔裙装，带有大量蕾丝和蝴蝶结装饰，女性化特征明显
是 | 穿着白色蕾丝女仆装搭配黑色丝袜，典型女装打扮
否 | 穿着蓝色 T 恤和牛仔裤，清爽少年感但为普通男装
否 | 穿着白色衬衫和黑色长裤，校园风男装
否 | 高浓度二次元卡通图片，动漫角色表情包
是 | 虽然可能是男性，但穿着粉色洛丽塔裙装，女装 cos"""
